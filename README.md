...
- [Introdução](https://github.com/engafs/clp_python/tree/master#introdu%C3%A7%C3%A3o)
- [Arquitetura do Projeto](https://github.com/engafs/clp_python/tree/master#%EF%B8%8F-arquitetura-do-projeto)
  - [Fluxo de Monitoramento (Leitura)](https://github.com/engafs/clp_python/tree/master#1--fluxo-de-monitoramento-leitura)
  - [Fluxo de Comando (Escrita)](https://github.com/engafs/clp_python/tree/master#2--fluxo-de-comando-escrita)
  - [Visualização de Monitoramento](https://github.com/engafs/clp_python/tree/master#3--visualiza%C3%A7%C3%A3o-do-monitoramento)
- [Arquitetura de Execução](https://github.com/engafs/clp_python/tree/master#-arquitetura-de-execu%C3%A7%C3%A3o)
- [Configuração da Arquitetura](https://github.com/engafs/clp_python/tree/master#%EF%B8%8F-configura%C3%A7%C3%A3o-da-arquitetura)
  - [Configuração do Ambiente de Desenvolvimento](https://github.com/engafs/clp_python/tree/master#-configura%C3%A7%C3%A3o-do-ambiente-de-desenvolvimento)
    - [1. Pré-requisitos do Sistema](https://github.com/engafs/clp_python/tree/master#1-%EF%B8%8F-pr%C3%A9-requisitos-do-sistema)
    - [2. Instalação de Dependências](https://github.com/engafs/clp_python/tree/master#2--instala%C3%A7%C3%A3o-de-depend%C3%AAncias)
    - [3. Estrutura de Pastas e Configuração](https://github.com/engafs/clp_python/tree/master#3--estrutura-de-pastas-e-configura%C3%A7%C3%A3o)
  - [Orquestração via YAML](https://github.com/engafs/clp_python/tree/master#%EF%B8%8F-orquestra%C3%A7%C3%A3o-via-yaml-configyaml)
    - [Conexões de rede](https://github.com/engafs/clp_python/tree/master#1--conex%C3%B5es-de-rede)
    - [Monitoramento de sensores/atuadores](https://github.com/engafs/clp_python/tree/master#2--monitoramento-de-sensoresatuadores)
    - [Comandos Remotos](https://github.com/engafs/clp_python/tree/master#3-%EF%B8%8F-comandos-remotos)
    - [Regras de alertas](https://github.com/engafs/clp_python/tree/master#4-%EF%B8%8F-regras-de-alertas)
    - [Monitoramento do Tempo de Vida Útil](https://github.com/engafs/clp_python/tree/master#5--monitoramento-do-tempo-de-vida-%C3%BAtil)
    - [Conexões e Credenciais (Telegram & E-mail)](https://github.com/engafs/clp_python/tree/master#6--conex%C3%B5es-e-credenciais-telegram--e-mail)
    - [Visualização dos dados (Dashboard)](https://github.com/engafs/clp_python/tree/master#7--visualiza%C3%A7%C3%A3o-dos-dados-dashboard)
  - [Configuração do Ambiente de Automação](https://github.com/engafs/clp_python/tree/master#%EF%B8%8F-configura%C3%A7%C3%A3o-do-ambiente-de-automa%C3%A7%C3%A3o)
- [Interface de Operação (Bot Telegram v1.0.0)](https://github.com/engafs/clp_python/tree/master#-interface-de-opera%C3%A7%C3%A3o-bot-telegram-v100)
  - [Comandos Públicos](https://github.com/engafs/clp_python/tree/master#-comandos-p%C3%BAblicos)
  - [Comandos de Administrador (Nível Privilegiado)](https://github.com/engafs/clp_python/tree/master#-comandos-de-administrador-n%C3%ADvel-privilegiado)
- [Conclusão e Próximos Passos](https://github.com/engafs/clp_python/tree/master#-conclus%C3%A3o-e-pr%C3%B3ximos-passos)
